...
4. Rubah nama folder menjadi "test_flip" karna default link untuk membuka applikasi http://localhost/test_flip/ atau bisa di ganti sesuai keinginan, hanya tinggal atur di config/config.php di bagian base_url nya
